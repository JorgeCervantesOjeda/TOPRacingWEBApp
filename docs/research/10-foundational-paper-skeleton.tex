...
If violation of commitments has no durable effect on future opportunity, then there exist parameter regimes in which opportunistic behavior is rational.
\end{proposition}

\begin{proof}[Proof sketch]
If an agent can obtain immediate gain through violation while facing no sufficiently large future loss in participation, reputation, or opportunity, then expected opportunistic utility exceeds compliant utility for some configurations of incentives.
\end{proof}

\begin{proposition}[Need for Bounded Advantage]
If prior resources fully determine relevant outcomes, then accessibility and developmentality cannot both be preserved in the intended sense.
\end{proposition}

\begin{proof}[Proof sketch]
If initial resource endowments dominate later opportunity, then bounded-resource agents lose meaningful entry or progression value. Under such conditions, either access ceases to be substantive or development ceases to be structurally supported.
\end{proof}
