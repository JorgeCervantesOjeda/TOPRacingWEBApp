...
\fi
\hypersetup{colorlinks=true,linkcolor=black,urlcolor=blue,pdftitle={SRS TOP Racing v2.7 normativa consolidada},pdfauthor={TOP Racing}}
\setstretch{1.06}
\sloppy
...
\vspace{1.1cm}
{\Large Versión 2.7 - libertad tecnológica, mercado competitivo y control verificable\par}
\vspace{0.4cm}
{\large Especificación normativa consolidada\par}
\vfill
{\large 12 de agosto de 2026\par}
\vspace{0.4cm}
{\small Fuente de procedencia: SRS IEEE 830 integrada heredada y registro de decisiones asociado.\par}
\end{titlepage}
\pagenumbering{roman}
\tableofcontents
\clearpage
...
Esta SRS define el comportamiento requerido del sistema TOP Racing y constituye la referencia normativa para análisis, diseño, implementación, verificación y aceptación. La versión 2.7 conserva la arquitectura documental normalizada de las versiones 2.0 a 2.6 e integra las decisiones confirmadas sobre subasta sellada de vehículos, eficiencia relativa al mercado, mérito tecnodeportivo, libertad tecnológica, pujas mínimas automáticas, competencia por prioridad entre eventos, reputación diferenciada del promotor y control verificable de protestas y exclusiones.

La versión 2.7 mantiene que la subasta de vehículos es sellada, exige verificación reforzada para las operaciones de riesgo, admite la puja del dueño sobre su propio vehículo, mantiene una sola puja vigente por usuario y vehículo y solo acepta sustituciones estrictamente mayores. Cada competidor del evento mantiene por defecto una puja vigente de una unidad monetaria por cada vehículo, incluido el propio, y el precio oficial conserva la lógica de segundo precio. No se publican resultados, conteos ni consecuencias derivadas antes del cierre. La línea de tendencia global modela los precios en función del rendimiento observado y la eficiencia mide la diferencia favorable o desfavorable entre el precio de tendencia y el precio oficial de subasta. La matriz de pesos usa ahora el Índice de Prioridad del Evento (IPE), que incorpora como factor competitivo el número de rivales, $N_a-1$, para evitar que un evento de un solo participante obtenga escala competitiva por competir contra sí mismo. Finalmente, esta versión corrige el significado de Technology Open: TOP Racing está abierto a cualquier tecnología compatible con las reglas publicadas del evento y no impone por ese concepto obligación de revelar, documentar, publicar o licenciar la solución técnica del vehículo.
...
En esta especificación, el término vehículo designa el artefacto competitivo de pista definido por la categoría del evento. La plataforma no presupone que dicho artefacto sea necesariamente un vehículo motorizado de alto costo; el dominio admite categorías con tecnología casera, artesanal, reutilizada, no motorizada o de bajo costo cuando las reglas publicadas del evento y sus restricciones de seguridad lo permitan, y permite cualquier tecnología compatible con las reglas técnicas, de seguridad, medición y participación publicadas por el evento, sin imponer una obligación general de revelar la solución técnica.
...
\noindent\textbf{Vehículo de competición.} artefacto físico admitido por una categoría de evento para producir rendimiento medible en pista; puede ser motorizado o no motorizado, de tecnología casera, artesanal, reutilizada, de bajo costo o de cualquier otra tecnología compatible con las reglas publicadas y las restricciones de seguridad del evento.\par
\noindent\textbf{Technology Open / apertura a la tecnología.} principio transversal de TOP Racing por el cual la competición está abierta al uso de cualquier tecnología compatible con las reglas publicadas del evento. No significa \emph{Open Technology}: TOP Racing no exige por este principio publicar, documentar, revelar, licenciar ni ceder secretos técnicos. La transferencia física obligatoria del vehículo adjudicado por subasta se rige por sus propias reglas y no convierte la solución técnica en información pública.\par
...
\noindent\textbf{Cuenta de pagos utilizable.} estado operativo de una cuenta de pagos asociada al usuario que permite a TOP Racing ejecutar, conforme a la integración vigente, autorizaciones, capturas, liberaciones, devoluciones o pagos requeridos por las operaciones económicas aplicables. En la implementación Java/MySQL vigente, este estado se satisface mediante una cuenta PayPal verificada por Seller Onboarding.\par
\noindent\textbf{Confirmación operativa de participante.} estado derivado por el cual la cuenta de participante queda habilitada para operación normal solo cuando el correo está confirmado y existe una cuenta de pagos utilizable; la confirmación de correo por sí sola no equivale a confirmación operativa.\par
...
\noindent\textbf{Índice de Prioridad del Evento (IPE).} indicador publicado propio de un evento que interviene en la determinación de su matriz de pesos conforme a las reglas del dominio. El IPE aumenta con el pozo económico oficial y con el número de rivales efectivos del evento, $N_a-1$, y disminuye con el costo efectivo por participante.\par
...
\noindent\textbf{Usuario con exclusión global.} usuario cuyo estado booleano de exclusión global está activo por decisión de \texttt{admin} y que, por ello, no puede participar operativamente en TOP Racing.\par
\noindent\textbf{Morosidad local.} declaración válida de incumplimiento operativo asociada a un promotor concreto y a un usuario concreto; por sí sola no equivale a exclusión global.\par
\noindent\textbf{Bloqueo local por promotor.} restricción operativa derivada de una morosidad local o de una protesta válida, aplicable solo a eventos presentes o futuros del mismo promotor.\par
...
\item SRS TOP Racing IEEE 830 integrada heredada: fuente completa de requisitos, decisiones, glosario y procedencia previa.
\item Registro de decisiones prioritarias del cliente: consolidado como DEC-001 a DEC-192 en el Anexo B; las decisiones superadas conservan su procedencia histórica y declaran expresamente su sustitución.
...
\item Campeonatos, clasificaciones, IPE, matriz de pesos y puntos escalados.
...
\noindent\textbf{BR-IAM-002.} La identidad verificada, la verificación reforzada, la exclusión global y los bloqueos locales por promotor son estados lógicos independientes.\par
\noindent\textbf{BR-IAM-003.} La participación operativa general requiere identidad verificada, ausencia de exclusión global activa y aceptación registrada de la versión vigente de términos y condiciones; la participación en eventos de un promotor concreto requiere además ausencia de bloqueo local vigente respecto de ese promotor.\par
...
\noindent\textbf{BR-IAM-005.} El nivel visible de acceso se deriva de los estados de verificación, exclusión global, bloqueos locales aplicables y aceptación legal; el estado de sesión no modifica por sí mismo ese nivel.\par
\noindent\textbf{BR-IAM-006.} La cuenta confirmada para operación normal se deriva de correo confirmado y cuenta de pagos utilizable. Si falta cualquiera de esos dos estados, el participante no debe quedar confirmado operativamente ni autenticado para operación normal. En la implementación Java/MySQL vigente, la cuenta de pagos utilizable se verifica mediante PayPal Seller Onboarding después de retorno asociado a tracking interno y consulta de estado al proveedor; los parámetros de retorno del navegador no bastan por sí solos para activar la cuenta.\par
...
\noindent\textbf{BR-EVT-003.} La convocatoria corresponde a la publicación del evento en estado \texttt{inscripciones}; las reglas, condiciones y datos públicos obligatorios deben estar publicados antes de abrir inscripciones y quedan inmutables para ese evento desde la apertura de inscripciones.\par
...
\noindent\textbf{BR-TEC-001.} TOP Racing es Technology Open: no impone como condición de dominio una tecnología motriz, energética, constructiva o de fabricación específica. Cada categoría de evento debe definir únicamente las condiciones técnicas, de seguridad, medición y participación que resulten necesarias para su operación, y dentro de ellas puede competir cualquier solución tecnológica compatible.\par
\noindent\textbf{BR-TEC-002.} Las reglas de una categoría pueden admitir tecnología casera, artesanal, reutilizada, no motorizada, de bajo costo, experimental, comercial o de cualquier otro origen, siempre que cumpla las restricciones publicadas del evento.\par
...
\noindent\textbf{BR-TEC-004.} Technology Open no equivale a Open Technology. TOP Racing no exige por ese principio que el dueño publique, documente, revele, licencie o ceda planos, software, firmware, procesos, materiales, configuraciones, secretos industriales u otra información técnica reservada.\par
\noindent\textbf{BR-TEC-005.} Cuando un tercero resulte adjudicatario de un vehículo, adquiere el artefacto físico en la condición exigida por las reglas de entrega y puede estudiarlo, inspeccionarlo, modificarlo, desmontarlo, reutilizarlo, revenderlo o volver a competir con él conforme a la ley y a las reglas de eventos posteriores. Esa transferencia física no crea por sí sola una obligación de divulgación documental del vendedor.\par
\noindent\textbf{BR-TEC-006.} La apertura a la tecnología no implica acceso irrestricto a todos los eventos. El promotor puede publicar reglas de acceso, cupo, seguridad, sede, elegibilidad operativa o participación compatibles con TOP Racing; una vez abiertas las inscripciones, esas reglas no pueden modificarse para ese evento.\par
...
\noindent\textbf{BR-AUC-003.} En cada subasta de vehículo existe exactamente una puja vigente por cada competidor del evento desde el inicio de la fase: el sistema mantiene por defecto una puja de una unidad monetaria por cada competidor sobre cada vehículo, incluido el propio. Cada usuario puede sustituir su puja vigente únicamente por otra de importe estrictamente mayor. La puja mínima automática usa como precedencia temporal la marca de inscripción válida del competidor.\par
\noindent\textbf{BR-AUC-004.} Cualquier usuario con verificación reforzada activa, aceptación vigente, sin exclusión global y sin bloqueo local vigente respecto del promotor aplicable puede pujar por vehículos con independencia de sus demás papeles funcionales. El dueño puede pujar por su propio vehículo.\par
...
\noindent\textbf{BR-AUC-006.} Toda puja vigente de un usuario distinto del dueño, incluida la puja mínima automática de una unidad, requiere respaldo económico suficiente antes de ser ejecutable; la implementación puede respaldar conjuntamente varias pujas mínimas siempre que garantice la exposición máxima aplicable. La puja del dueño sobre su propio vehículo está exenta de retención del principal, pero no de la comisión aplicable al comprador cuando resulte adjudicatario.\par
\noindent\textbf{BR-AUC-007.} Después del cierre de una subasta, cualquier usuario puede solicitar, mediante el pago de una tarifa a TOP Racing, una revelación privada del registro íntegro de pujas de esa subasta. La revelación es visible únicamente para quien paga y no altera el resultado oficial ni convierte las pujas en información pública general.\par
...
\noindent\textbf{BR-PUB-002.} Todo resultado oficial debe conservar rastro verificable suficiente hacia sus datos de origen y las reglas aplicadas.\par
...
\noindent\textbf{BR-WGT-003.} Cuando dos eventos comparables se afectan, el IPE determina cuál conserva peso y cuál desciende en la secuencia base; los empates de IPE favorecen al evento registrado antes.\par
\noindent\textbf{BR-WGT-004.} El costo efectivo por participante es el costo económico mínimo obligatorio publicado de una inscripción ordinaria más la parte imputable de costos obligatorios compartidos: cuota obligatoria de inscripción, cargo obligatorio de renta de pista imputable a la inscripción y costo obligatorio de pesaje imputable a la inscripción cuando exista. No incluye aportaciones voluntarias, patrocinios, pujas, compras de vehículos, retenciones reembolsables ni comisiones por beneficios posteriores.\par
\noindent\textbf{BR-WGT-005.} El IPE propio del evento usa como factor de escala competitivo el número de rivales efectivos, $Q(e)=\max(N_a(e)-1,0)$. Si la renta se publica únicamente como costo total del evento, su imputación analítica por participante sigue usando el número de participantes activos; si todavía no existe un número positivo, se usa la convención operativa de un participante únicamente para evitar división por cero en el costo. Un evento con un solo participante tiene factor competitivo cero para el IPE, aunque conserva sus resultados, historial y clasificaciones locales aplicables.\par
...
\noindent\textbf{BR-WGT-007.} La matriz de pesos crea una presión de diferenciación institucional: un promotor puede mejorar el IPE de su evento para competir dentro de un ámbito congestionado o puede elegir otro territorio o periodo que reduzca el conjunto de eventos comparables, sujeto a las reglas efectivas de campeonatos y comparación.\par
...
\noindent\textbf{BR-BUS-005.} Las reglas económicas aceptadas por el usuario deben distinguir entre cancelación reembolsable y descalificación por incumplimiento. Una descalificación por incumplimiento, fraude, conducta insegura, no entrega del vehículo, modificación indebida o violación de reglas no genera devolución automática a favor del participante descalificado; cualquier excepción requiere revisión documentada y decisión explícita conforme a las reglas del evento y a la ley aplicable.\par
...
\noindent\textbf{CALC-WGT-001 --- Índice de Prioridad del Evento (IPE)}\par
Para un evento $e$, sea $P(e)$ el pozo económico oficial, $N_a(e)$ el número de participantes activos, $I(e)$ la cuota obligatoria de inscripción, $R_{total}(e)$ el cargo obligatorio de renta de pista cuando se registra como costo total del evento, $R(e)$ el cargo obligatorio de renta de pista imputable a una inscripción y $W(e)$ el costo obligatorio de pesaje imputable a una inscripción cuando exista. Se define $N(e)=N_a(e)$ si $N_a(e)>0$ y $N(e)=1$ en caso contrario únicamente para imputar costos compartidos, y se define el número de rivales efectivos $Q(e)=\max(N_a(e)-1,0)$. Si la renta se publica únicamente como costo total, $R(e)=R_{total}(e)/N(e)$. El costo efectivo por participante es $C(e)=I(e)+R(e)+W(e)$. Si $W(e)$ no existe como campo publicado en la implementación vigente, se usa $W(e)=0$. Cuando $C(e)>0$, $IPE(e)=P(e)\times Q(e)/C(e)$. Cuando $C(e)\le0$, se usa $C(e)=1$ como convención operativa de ordenamiento. Los empates de IPE favorecen al evento registrado antes.\par\vspace{0.5em}
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe publicar los resultados oficiales de un evento con rastro verificable hacia los datos y reglas aplicados.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-PAY-004 --- Registro verificable del premio individual del evento}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe registrar con rastro verificable el premio individual del evento correspondiente a cada competidor computable.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-PAY-007 --- Devolución inmediata por cancelación reembolsable previa a carrera}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe devolver inmediatamente las cantidades cobradas que correspondan cuando el evento se cancele o cuando una inscripción quede cancelada antes de \texttt{carrera} por causa no atribuible al participante. Una descalificación por incumplimiento del participante no genera devolución automática a favor del participante descalificado; el sistema debe conservar el efecto económico aplicable y remitir los casos ambiguos a revisión documentada.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir pujar en subastas de vehículos a cualquier usuario con verificación reforzada activa, aceptación vigente de términos, sin exclusión global y sin bloqueo local vigente respecto del promotor aplicable, con independencia de sus demás papeles funcionales.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener exactamente una puja vigente por cada competidor y vehículo del evento al iniciar la subasta, creando por defecto una puja de una unidad monetaria sobre cada vehículo, incluido el propio, y aceptar posteriormente su sustitución únicamente por un importe estrictamente mayor que la puja vigente anterior.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Al cerrar la fase de subasta de vehículos del evento, el sistema debe declarar adjudicatario al usuario con la mayor puja vigente; si varias pujas máximas tienen el mismo importe, gana la que alcanzó primero ese importe. Con al menos dos pujas válidas, el precio oficial es el segundo importe vigente más alto, incluyendo la puja válida del dueño; con una sola puja válida, el precio oficial es una unidad monetaria por convención.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si, antes de iniciar la subasta, el dueño no entrega inmediatamente el vehículo al promotor al terminar la carrera o lo modifica o daña deliberadamente antes de esa entrega, el sistema debe permitir al promotor descalificar a ese competidor, declararlo moroso y aplicar bloqueo local respecto de sus propios eventos conforme a las reglas de bloqueo local por promotor; el promotor puede además solicitar a \texttt{admin} una exclusión global de TOP Racing. Una vez iniciada la subasta, el promotor no puede descalificar al competidor ni alterar la elegibilidad del vehículo para esa subasta.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener respaldo económico suficiente para toda puja vigente presentada por un usuario distinto del dueño del vehículo, incluidas las pujas mínimas automáticas de una unidad; puede utilizar respaldo agregado cuando garantice la exposición máxima aplicable a las adjudicaciones posibles.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-AUC-030 --- Exclusión global del promotor declarado moroso por disputa de entrega}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando la resolución administrativa mantenga al promotor como moroso, el sistema debe activar su exclusión global.
\item[Prioridad] Alta
\item[Procedencia] Decisiones prioritarias del cliente sobre resolución por \texttt{admin} y efectos de la morosidad del promotor.; ID heredado: \texttt{RF-050J}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-AUC-036 --- Revelación privada posterior de pujas mediante tarifa a TOP Racing}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Después del cierre de una subasta de vehículo, el sistema debe permitir que cualquier usuario pague la tarifa vigente a TOP Racing para consultar privadamente el registro íntegro de pujas de esa subasta; la consulta no debe hacerse pública para terceros ni alterar el resultado oficial.
\item[Prioridad] Media
\item[Procedencia] DEC-186; decisión confirmada sobre auditoría privada de pujas por tarifa.
\item[Verificación] \texttt{AC-RF-AUC-036}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-PUB-003 --- Rastro verificable de resultados oficiales hacia reglas y datos de origen}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener visibles en la consulta del evento las protestas de seguridad tramitadas, el total y detalle de la votación formal cuando exista, y la resolución final emitida por el promotor con su resultado, incluso cuando la resolución sea contraria a la mayoría informativa o no cancele la inscripción afectada; la identidad de quien presentó originalmente la protesta permanece reservada conforme a RF-PUB-007.
\item[Prioridad] Media
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-PUB-010 --- Historial y rastro temporal verificable de disputas de entrega de vehículos adjudicados}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
...
\item[Prioridad] Alta
\item[Procedencia] RF-050G a RF-050J, RF-067D, RF-067E y fuentes prioritarias confirmadas por el usuario sobre historial y rastro temporal verificable de la disputa de entrega.; ID heredado: \texttt{RF-070A}.
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe exigir que la identidad del usuario esté verificada antes de habilitarle cualquier función que implique participación operativa en el ecosistema. En la implementación Java/MySQL vigente, la verificación operativa mínima requiere correo confirmado y cuenta de pagos utilizable mediante PayPal Seller Onboarding.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe exigir, antes de habilitar cualquier función de participación operativa, que el usuario tenga registrada la aceptación explícita de la versión vigente de los términos y condiciones aplicables. Dicha versión debe poder consultarse antes de aceptarla y en cualquier momento desde el perfil del participante, mostrando versión, fecha de vigencia y texto completo. Las condiciones deben informar en lenguaje claro las reglas económicas materiales de inscripción, puja, entrega de vehículo, cancelación, devolución, no devolución por descalificación o incumplimiento, bloqueos, morosidad y exclusión aplicables a la operación que el usuario pretenda ejecutar. La aceptación debe registrar participante, versión aceptada y fecha/hora de aceptación; cuando cambie la versión vigente, el sistema debe exigir nueva aceptación antes de permitir operaciones protegidas. La redacción legal final puede variar por país, pero el sistema debe conservar esta base mínima de aviso, consulta, aceptación explícita y registro verificable.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-006 --- Restricción de acceso por morosidad local o exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe impedir que un usuario declarado moroso por decisión válida del promotor acceda a operaciones de eventos presentes o futuros de ese mismo promotor, sin producir por ello una exclusión global de TOP Racing. El sistema debe impedir el acceso global a funciones operativas solo cuando \texttt{admin} declare o mantenga una exclusión global dentro del flujo aplicable de subasta, entrega o seguridad.
\item[Prioridad] Alta
\item[Procedencia] RF-050B, RF-050J, DEC-189 y DEC-190; separación entre morosidad o bloqueo local del promotor y exclusión global decidida por \texttt{admin}.; ID heredado: \texttt{RF-072B}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-013 --- Registro lógico del estado de exclusión global del usuario}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener para cada usuario un estado booleano independiente que indique si el usuario tiene exclusión global activa o no tiene exclusión global activa.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-014 --- Facultad global de admin sobre verificación y exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir exclusivamente a \texttt{admin} verificar la identidad de cualquier usuario e imponer, modificar o levantar una exclusión global de TOP Racing. La decisión global de exclusión es definitiva e inapelable dentro del sistema y, cuando se impone, debe publicarse con su alcance temporal y una razón suficiente sin exponer información reservada innecesaria.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-016 --- Facultad limitada del promotor sobre verificación y bloqueo local}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir que el promotor verifique la identidad de usuarios vinculados operativamente a un evento que promueve y aplique bloqueo local al usuario afectado respecto de eventos presentes o futuros de ese mismo promotor únicamente cuando exista una protesta registrada por otro competidor o una morosidad local válida por incumplimiento de entrega o modificación indebida del vehículo antes de la subasta. La votación de los participantes sobre la protesta es informativa y no vinculante. El promotor no puede imponer por sí mismo una exclusión global de TOP Racing.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-018 --- Efecto combinado de verificación, exclusión global, bloqueos locales y aceptación vigente}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe habilitar la participación operativa general de un usuario únicamente cuando su identidad está verificada, su exclusión global no está activa y tenga registrada la aceptación vigente de términos y condiciones. Para operaciones en eventos de un promotor concreto, el sistema debe exigir además que no exista bloqueo local vigente respecto de ese promotor. En la implementación Java/MySQL vigente, el estado operativo confirmado del participante requiere además correo confirmado y cuenta de pagos utilizable mediante PayPal Seller Onboarding.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-020 --- Cancelación de sesión en curso por exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando la exclusión global de un usuario pase a estado activo, el sistema debe cancelar toda sesión vigente de ese usuario.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.; ID heredado: \texttt{RF-151B}.
\item[Verificación] \texttt{AC-RF-IAM-020}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-021 --- Rechazo de inicio de sesión durante exclusión global activa}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Mientras la exclusión global de un usuario permanezca activa, el sistema debe rechazar su inicio de sesión.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.; ID heredado: \texttt{RF-151B}.
\item[Verificación] \texttt{AC-RF-IAM-021}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-022 --- Mensaje de exclusión global al rechazar el inicio de sesión}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando un inicio de sesión sea rechazado por exclusión global activa, la interfaz debe mostrar el mensaje de exclusión correspondiente.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.; ID heredado: \texttt{RF-151B}.
\item[Verificación] \texttt{AC-RF-IAM-022}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-023 --- Conservación de rastro verificable de cambios en verificación, exclusión global y bloqueos locales}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe conservar rastro verificable de cada cambio válido en los estados de identidad verificada, verificación reforzada, exclusión global y bloqueo local por promotor, incluyendo quién lo realizó, cuándo lo realizó, sobre qué usuario recayó y, cuando aplique, a qué promotor corresponde el bloqueo local.
\item[Prioridad] Media
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-024 --- Exclusión global de nueva identidad detectada como correspondiente a un usuario con exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si el sistema detecta que una nueva identidad corresponde a una persona con exclusión global activa, debe activar también la exclusión global de esa nueva identidad.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-033 --- Visibilidad general de usuarios no verificados y reserva de usuarios con exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] La falta de verificación de identidad no debe ocultar por sí misma a un usuario en las consultas del sistema que le correspondan; en cambio, los usuarios con exclusión global activa solo deben ser visibles en las consultas generales de usuarios para \texttt{admin}, sin perjuicio de que el propio usuario pueda consultar sus estados, su nivel y los bloqueos locales que le correspondan.
\item[Prioridad] Media
\item[Procedencia] Secciones 2.3, 2.5, RF-148, RF-154 y decisiones prioritarias del cliente sobre usuarios no verificados y usuarios con exclusión global.; ID heredado: \texttt{RF-157}.
\item[Verificación] \texttt{AC-RF-IAM-033}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-034 --- Solicitud del promotor de exclusión global a admin}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir que un promotor remita a \texttt{admin} una solicitud razonada de exclusión global de TOP Racing respecto de un usuario sobre el que exista antecedente operativo en sus eventos; la solicitud no produce exclusión global por sí misma.
\item[Prioridad] Alta
\item[Procedencia] DEC-190; decisión confirmada sobre separación entre bloqueo local del promotor y exclusión global de TOP Racing.
\item[Verificación] \texttt{AC-RF-IAM-034}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-IAM-035 --- Privacidad de solicitudes globales rechazadas y publicación de exclusiones aceptadas}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si \texttt{admin} rechaza una solicitud de exclusión global, la solicitud, sus razones y el rechazo deben conservar rastro verificable pero no publicarse; deben ser consultables por \texttt{admin}, el promotor solicitante y el usuario afectado. Si \texttt{admin} impone la exclusión global, la decisión final, su alcance temporal y una razón suficiente deben publicarse sin divulgar material reservado innecesario.
\item[Prioridad] Alta
\item[Procedencia] DEC-191; decisión confirmada sobre prevención de daño reputacional por solicitudes rechazadas.
\item[Verificación] \texttt{AC-RF-IAM-035}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-VEH-015 --- Devolución inmediata por cancelación reembolsable previa a carrera}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si una inscripción queda cancelada antes de \texttt{carrera} por causa no atribuible al participante, el sistema debe devolver de inmediato los importes cobrados por inscripción, aportación mínima y renta de pista asociados a esa inscripción, así como las aportaciones de terceros cobradas a favor de ese participante dentro del evento. Si la inscripción queda descalificada por incumplimiento, fraude, conducta insegura, no entrega del vehículo, modificación indebida o violación de reglas, el sistema no debe ejecutar devolución automática a favor del participante descalificado y debe conservar el efecto económico correspondiente con la nota de la descalificación.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si, antes de iniciar la subasta, el dueño no entrega inmediatamente el vehículo al promotor al terminar la carrera o lo modifica o daña deliberadamente antes de esa entrega, el sistema debe permitir al promotor descalificar al competidor, declararlo moroso y aplicar bloqueo local respecto de sus propios eventos; el promotor puede solicitar a \texttt{admin} la exclusión global de TOP Racing. Una vez iniciada la subasta, la descalificación ya no puede utilizarse para alterar esa subasta.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-EPR-003 --- Correspondencia verificable entre premio individual del evento y distribución posterior}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener una correspondencia verificable entre el premio individual del competidor en el evento y la distribución económica posterior asociada a ese premio dentro del mismo evento.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe conservar rastro verificable de que toda aportación realizada a la contribución de un participante dentro de un campeonato tiene como finalidad compartir el premio que le corresponda a ese participante y aumentar su magnitud.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-CPR-008 --- Rastro verificable económico del patrocinio de campeonato}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe conservar la relación verificable entre las aportaciones directas a la bolsa del campeonato, los anuncios publicados, las aportaciones a participantes y la distribución económica correspondiente.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.6.2 y 2.6.4.3 y decisiones prioritarias del cliente sobre patrocinio y aportaciones a participantes.; ID heredado: \texttt{RF-101}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-CPR-024 --- Correspondencia verificable entre premio individual del campeonato y distribución posterior}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe mantener una correspondencia verificable entre el premio individual del competidor en el campeonato y la distribución económica posterior asociada a ese resultado dentro de ese mismo campeonato.
\item[Prioridad] Media
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-WGT-002 --- Determinación del Índice de Prioridad propio del evento}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe determinar y conservar el Índice de Prioridad (IPE) propio del evento como un indicador derivado del pozo económico oficial, el número de participantes activos y el costo efectivo por participante del propio evento, conforme a \texttt{CALC-WGT-001}.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-WGT-006 --- Conservación del peso del evento con mayor IPE}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando una comparación operativa entre eventos requiera ajustar pesos, el sistema debe conservar el peso del evento con mayor IPE.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-WGT-007 --- Descenso del peso del evento con menor IPE}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando una comparación operativa entre eventos requiera ajustar pesos, el sistema debe hacer descender el peso del evento con menor IPE al siguiente valor de la secuencia base vigente.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.6.3.1 y decisiones prioritarias del cliente confirmadas sobre secuencia y desempate, además de la fuente documental TOP\_Racing\_Grok\_Clarified.tex (líneas 171 y 210).; ID heredado: \texttt{RF-108}.
\item[Verificación] \texttt{AC-RF-WGT-007}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-WGT-008 --- Desempate de IPE por antigüedad de registro}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando dos eventos comparables tengan el mismo IPE, el sistema debe favorecer al evento registrado más temprano.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.6.3.1 y decisiones prioritarias del cliente confirmadas sobre secuencia y desempate, además de la fuente documental TOP\_Racing\_Grok\_Clarified.tex (líneas 171 y 210).; ID heredado: \texttt{RF-108}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-WGT-011 --- Publicación con rastro verificable del Índice de Prioridad y de la matriz de pesos vigente}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe publicar con rastro verificable el Índice de Prioridad propio del evento, la matriz de pesos vigente, la secuencia aplicada cuando haya ajustes y los campeonatos y clasificaciones a los que el evento aporta resultados.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-EFF-008 --- Conservación con rastro verificable de la muestra y parámetros de tendencia}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe conservar con rastro verificable la muestra oficial usada por la regresión y los parámetros ajustados de la línea de tendencia aplicable al evento.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-EFF-014 --- Publicación del rastro verificable de eficiencia después del cierre}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-SPN-007 --- Rastro verificable económico del patrocinio y aportaciones del evento}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe conservar la relación verificable entre aportaciones directas cobradas a la bolsa, anuncios publicados, aportaciones cobradas de eficiencia o terminación y distribuciones económicas correspondientes.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.6.2, 2.6.4.2, RF-126, RF-127, RF-127A y RF-128.; ID heredado: \texttt{RF-129}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-SPN-009 --- Devolución inmediata de aportaciones a participante por cancelación reembolsable previa a carrera}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Si una inscripción de participante queda cancelada antes de \texttt{carrera} por causa no atribuible al participante, el sistema debe devolver inmediatamente las aportaciones de terceros cobradas a favor de ese participante tanto para eficiencia como para terminación dentro del evento. Si la inscripción queda descalificada por incumplimiento del participante, las aportaciones de terceros no se devuelven automáticamente al participante descalificado; el sistema debe aplicar la regla económica aceptada y remitir los casos ambiguos a revisión documentada.
\item[Prioridad] Alta
\item[Procedencia] Secciones 2.6.4 y decisión confirmada por el usuario sobre devolución inmediata por cancelación reembolsable y ausencia de devolución automática por descalificación atribuible al participante.; ID heredado: \texttt{RF-129B}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RF-PTS-011 --- Publicación con rastro verificable de la actualización de puntos y clasificaciones por modalidad}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe publicar con rastro verificable, para cada campeonato aplicable, la relación entre los resultados oficiales del evento, la base de puntos por modalidad, el peso vigente del evento, la puntuación escalada resultante y la actualización de las clasificaciones correspondientes.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir que \texttt{admin} ejerza moderación sobre el foro comunitario y sobre el canal de novedades del ecosistema sin alterar por ello las demás reglas del dominio sobre publicidad, reserva o rastro verificable.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir que los participantes de un evento registren después del evento una calificación del promotor de una a cinco estrellas y un comentario textual opcional, identificada como opinión de competidor.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe permitir que los espectadores de un evento registren después del evento una calificación del promotor de una a cinco estrellas y un comentario textual opcional, identificada como opinión de espectador.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe determinar y conservar por separado la reputación del promotor derivada de calificaciones de competidores y la reputación derivada de calificaciones de espectadores; no debe fusionarlas en un único promedio.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe vincular con los eventos futuros del promotor ambas reputaciones vigentes, competidores y espectadores, y conservar los comentarios asociados en sus respectivas categorías.
\item[Prioridad] Media
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Cuando se active la exclusión global de un usuario con una sesión en curso, el sistema debe cancelar esa sesión.
\item[Prioridad] Alta
\item[Procedencia] Secciones 1.2, 2.1, 2.2, 2.3, 2.4, 3.1.11, 3.1.24, 3.1.25 y decisiones prioritarias del cliente sobre página principal, niveles de verificación y aceptación legal previa y versionada.; ID heredado: \texttt{RIE-001}.
\item[Verificación] \texttt{AC-UI-005}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{UI-006 --- Bloqueo de inicio de sesión de usuario con exclusión global}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe rechazar el inicio de sesión de un usuario con exclusión global activa y debe mostrar el mensaje de exclusión correspondiente.
\item[Prioridad] Alta
\item[Procedencia] Secciones 1.2, 2.1, 2.2, 2.3, 2.4, 3.1.11, 3.1.24, 3.1.25 y decisiones prioritarias del cliente sobre página principal, niveles de verificación y aceptación legal previa y versionada.; ID heredado: \texttt{RIE-001}.
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] La interfaz del sistema debe permitir que participantes y espectadores registren después del evento una valoración de una a cinco estrellas y un comentario opcional, mostrando y conservando separadas las valoraciones y comentarios de competidores respecto de las de espectadores.
\item[Prioridad] Media
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{UI-066 --- Publicación de discriminadores y IPE por evento}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] Para cada evento del corte consultado, la interfaz debe publicar sus discriminadores territoriales y temporales, estado, organizador, fecha, pista o variante aplicable y IPE propio.
\item[Prioridad] Alta
\item[Procedencia] Secciones 1.2, 2.2, 2.4, 3.1.16, RF-104, RF-109 y análisis funcional confirmado de la app legacy sobre la consulta de prioridades de eventos por selección de nivel temporal y territorial.; ID heredado: \texttt{RIE-017}.
\item[Verificación] \texttt{AC-UI-066}
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{UI-067 --- Ordenamiento consultable por IPE}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] La interfaz pública de prioridades debe permitir ordenar los eventos consultados por su IPE publicado.
\item[Prioridad] Alta
\item[Procedencia] Secciones 1.2, 2.2, 2.4, 3.1.16, RF-104, RF-109 y análisis funcional confirmado de la app legacy sobre la consulta de prioridades de eventos por selección de nivel temporal y territorial.; ID heredado: \texttt{RIE-017}.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{UI-070 --- Declaración de categoría tecnológica abierta a soluciones diversas}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] La interfaz de publicación del evento debe permitir declarar las condiciones técnicas y de seguridad aplicables y debe informar expresamente que TOP Racing es Technology Open: cualquier tecnología compatible con esas condiciones puede participar. La interfaz no debe exigir documentación técnica abierta ni revelación de secretos como condición general de TOP Racing.
\item[Prioridad] Alta
\item[Procedencia] DEC-173, DEC-174, DEC-181 y DEC-182; corrección confirmada del significado de Technology Open y eliminación de la obligación general de documentación técnica abierta.
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{RC-EXT-006 --- Verificación de identidad, ausencia de exclusión global y ausencia de bloqueo local antes de la participación}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe exigir que la identidad del usuario esté verificada, que su exclusión global no esté activa y que no exista bloqueo local vigente respecto del promotor aplicable antes de permitirle participación operativa en un evento concreto del ecosistema TOP Racing.
\item[Prioridad] Alta
...
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
\item[Obligación] El sistema debe exigir la aceptación registrada de la versión vigente de términos y condiciones antes de permitir cualquier participación operativa en el ecosistema TOP Racing. Esa versión debe estar disponible para consulta antes de la aceptación y desde el perfil del participante, con versión, fecha de vigencia y texto completo. Debe informar de forma visible y en lenguaje claro las consecuencias económicas materiales de cada operación sensible, incluidas devoluciones, casos no reembolsables por descalificación o incumplimiento, entrega de vehículo, bloqueos, morosidad y exclusión. La aceptación debe conservar participante, versión y fecha/hora; una nueva versión debe invalidar la aceptación operativa anterior hasta que el usuario acepte la versión vigente. La adaptación jurídica concreta por país queda fuera de esta regla técnica mínima y debe validarse antes de operar pagos reales en esa jurisdicción.
\item[Prioridad] Alta
...
\end{description}
\vspace{0.25em}\hrule\vspace{0.65em}
\noindent\textbf{QR-002 --- Auditabilidad y rastro verificable de operaciones críticas}\par
\begin{description}[style=nextline,leftmargin=3.15cm,labelwidth=2.8cm,font=\normalfont\bfseries]
...
\noindent\textbf{AC-RF-PAY-004 --- Registro verificable del premio individual del evento}\par
\textbf{Método:} Prueba funcional de caja negra.\par
...
\noindent\textbf{AC-RF-PAY-007 --- Devolución inmediata por cancelación reembolsable previa a carrera}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si el evento se cancela o una inscripción queda cancelada antes de \texttt{carrera} por causa no atribuible al participante, el sistema ejecuta de inmediato la devolución de los cobros aplicables, incluidas las aportaciones de terceros asociadas a ese participante dentro del evento. Si la inscripción queda descalificada por incumplimiento del participante, el sistema no ejecuta devolución automática a favor del participante descalificado y conserva la nota y el efecto económico aplicable.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Al iniciar la subasta existe para cada competidor y vehículo una puja vigente automática de una unidad; intentar sustituirla o cualquier puja posterior por importes inferior, igual y superior y comprobar que solo el superior se acepta y pasa a ser la única puja vigente.\par\vspace{0.45em}
...
\textbf{Oráculo:} Un usuario con verificación reforzada activa, términos vigentes, sin exclusión global y sin bloqueo local respecto del promotor aplicable puede pujar aunque no tenga otro papel funcional; usuarios por debajo del nivel máximo, con exclusión global o con bloqueo local aplicable son rechazados.\par\vspace{0.45em}
...
\textbf{Oráculo:} Al cerrar la fase, la mayor puja vigente determina al adjudicatario; un empate de máximo favorece a quien alcanzó primero ese importe. Con dos o más pujas válidas, el segundo importe vigente más alto determina el precio oficial, sin excluir la puja del dueño; con una única puja válida, el precio oficial es una unidad monetaria.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si, antes de iniciar la subasta, el promotor registra no entrega, modificación o daño deliberado previo a custodia, el sistema permite descalificar, declarar morosidad y aplicar bloqueo local por promotor, además de remitir solicitud de exclusión global a admin; una vez iniciada la subasta, el sistema rechaza una descalificación destinada a alterar esa subasta.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-AUC-030 --- Exclusión global del promotor declarado moroso por disputa de entrega}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Resolver una disputa manteniendo la morosidad del promotor y comprobar que el sistema activa su exclusión global sin invalidar eventos ya realizados.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-AUC-036 --- Revelación privada posterior de pujas mediante tarifa a TOP Racing}\par
\textbf{Método:} Prueba funcional posterior al cierre con usuario solicitante y otro usuario no solicitante.\par
\textbf{Oráculo:} Tras cobrar la tarifa a TOP Racing, solo el solicitante puede consultar el registro íntegro de pujas de la subasta; otro usuario no obtiene ese acceso y el resultado oficial permanece inalterado.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-PUB-003 --- Rastro verificable de resultados oficiales hacia reglas y datos de origen}\par
\textbf{Método:} Prueba funcional de caja negra.\par
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si una protesta de seguridad fue registrada, la consulta pública permite ver su tramitación, la votación formal cuando exista y la resolución final del promotor, incluso cuando sea contraria a la mayoría informativa; no revela la identidad reservada de quien presentó originalmente la protesta.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-PUB-010 --- Historial y rastro temporal verificable de disputas de entrega de vehículos adjudicados}\par
\textbf{Método:} Prueba funcional de caja negra.\par
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si un usuario no tiene identidad verificada, correo confirmado o cuenta de pagos utilizable cuando esas condiciones apliquen a la implementación vigente, el sistema no le habilita operaciones de inscripción, puja, aportación, promoción, protesta ni otras funciones de participación operativa.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-003 --- Aceptación versionada de términos y condiciones previa a la participación}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si un usuario no tiene registrada la aceptación de la versión vigente de los términos y condiciones, el sistema no le habilita funciones de inscripción, puja, aportación, promoción, protesta ni otras funciones de participación operativa. La versión vigente se puede consultar antes de aceptarse y desde el perfil del participante; muestra versión, fecha de vigencia y texto completo en lenguaje claro. La versión aceptada incluye las reglas económicas materiales de devolución, no devolución por descalificación o incumplimiento, entrega de vehículo, bloqueos, morosidad y exclusión aplicables a las operaciones sensibles. Al aceptar, el sistema registra participante, versión y fecha/hora; si cambia la versión vigente, la aceptación previa deja de habilitar operaciones protegidas hasta aceptar la nueva versión.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-IAM-006 --- Restricción de acceso por morosidad local o exclusión global}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando un promotor declara válidamente moroso a un usuario dentro del flujo de subasta y entrega de vehículos, el sistema bloquea las operaciones de ese usuario en eventos presentes o futuros de ese promotor, pero no activa exclusión global. Cuando \texttt{admin} declara o mantiene una exclusión global, el sistema deja de permitirle el acceso global a funciones operativas.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-VEH-015 --- Devolución inmediata por cancelación reembolsable previa a carrera}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando una inscripción queda cancelada antes de \texttt{carrera} por causa no atribuible al participante, el sistema ejecuta de inmediato la devolución de todos los importes cobrados asociados a esa inscripción y de las aportaciones de terceros cobradas a favor de ese participante en el evento. Cuando la inscripción queda descalificada por incumplimiento, el sistema no ejecuta devolución automática a favor del participante descalificado y conserva la nota y el efecto económico correspondiente.\par\vspace{0.45em}
\noindent\textbf{AC-RF-VEH-016 --- Descalificación y morosidad del dueño por no entrega o modificación del vehículo}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Si, antes de iniciar la subasta, el promotor registra la no entrega, modificación o daño deliberado previo a custodia, el sistema permite descalificar al competidor, declararlo moroso y excluirlo de los eventos del propio promotor, y permite al promotor solicitar a admin una exclusión global; una vez iniciada la subasta, esa descalificación no puede alterar la subasta.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-EPR-003 --- Correspondencia verificable entre premio individual del evento y distribución posterior}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\noindent\textbf{AC-RF-CPR-008 --- Rastro verificable económico del patrocinio de campeonato}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\noindent\textbf{AC-RF-WGT-002 --- Determinación del Índice de Prioridad propio del evento}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
\textbf{Oráculo:} Para un evento con pozo económico oficial, número de participantes activos y costo efectivo por participante determinados, el sistema produce un único valor de IPE propio del evento conforme a \texttt{CALC-WGT-001} y lo mantiene distinguible de la matriz de pesos vigente.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-WGT-006 --- Conservación del peso del evento con mayor IPE}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
\textbf{Oráculo:} Comparar dos eventos ajustables con IPE distintos y comprobar que el peso del evento con mayor IPE no desciende por esa comparación.\par\vspace{0.45em}
\noindent\textbf{AC-RF-WGT-007 --- Descenso del peso del evento con menor IPE}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
\textbf{Oráculo:} Comparar dos eventos ajustables con IPE distintos y comprobar que el evento con menor IPE adopta el siguiente valor definido de la secuencia base.\par\vspace{0.45em}
\noindent\textbf{AC-RF-WGT-008 --- Desempate de IPE por antigüedad de registro}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
\textbf{Oráculo:} Comparar dos eventos con IPE iguales y marcas temporales de registro distintas; comprobar que el evento más antiguo recibe el tratamiento favorable previsto para la comparación.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-WGT-011 --- Publicación con rastro verificable del Índice de Prioridad y de la matriz de pesos vigente}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
\textbf{Oráculo:} Un usuario puede consultar para un evento el IPE propio, la matriz de pesos vigente, la lógica de ajuste aplicada cuando corresponda y los campeonatos y clasificaciones aplicables como partes vinculadas de la misma publicación.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-EFF-008 --- Conservación con rastro verificable de la muestra y parámetros de tendencia}\par
...
\noindent\textbf{AC-RF-EFF-014 --- Publicación del rastro verificable de eficiencia después del cierre}\par
...
\noindent\textbf{AC-RF-EPR-020 --- Publicación con rastro verificable del patrocinio y de los premios del evento}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\noindent\textbf{AC-RF-CPR-019 --- Publicación y rastro verificable del patrocinio y del premio de campeonato}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\noindent\textbf{AC-RF-SPN-007 --- Rastro verificable económico del patrocinio y aportaciones del evento}\par
\textbf{Método:} Prueba funcional de caja negra.\par
...
\noindent\textbf{AC-RF-SPN-009 --- Devolución inmediata de aportaciones a participante por cancelación reembolsable previa a carrera}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando una inscripción de participante queda cancelada antes de \texttt{carrera} por causa no atribuible al participante, el sistema devuelve de inmediato las aportaciones de terceros cobradas a su favor dentro del evento para eficiencia y para terminación. Cuando la inscripción queda descalificada por incumplimiento del participante, el sistema no devuelve automáticamente dichas aportaciones al participante descalificado y conserva el efecto económico aplicable.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-PTS-011 --- Publicación con rastro verificable de la actualización de puntos y clasificaciones por modalidad}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\noindent\textbf{AC-RF-CPR-024 --- Correspondencia verificable entre premio individual del campeonato y distribución posterior}\par
\textbf{Método:} Prueba funcional con conjunto de datos de referencia y análisis de derivación.\par
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} \texttt{admin} dispone de funciones de moderación aplicables al foro comunitario y al canal de novedades, y el ejercicio de esas funciones no cambia por sí mismo las reglas generales del dominio sobre qué información debe permanecer pública, reservada o con rastro verificable.\par\vspace{0.45em}
\noindent\textbf{AC-RF-GOV-005 --- Permanencia histórica de publicaciones y procesos críticos visibles}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando una publicación o un proceso crítico del dominio deba permanecer visible con rastro histórico verificable, el sistema lo mantiene consultable en el historial aplicable junto con los datos públicos que las reglas correspondientes exijan.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-IAM-013 --- Registro lógico del estado de exclusión global del usuario}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Para cada cuenta individual, el sistema conserva un valor lógico verificable que expresa si el usuario tiene exclusión global activa o no tiene exclusión global activa.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-014 --- Facultad global de admin sobre verificación y exclusión global}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} \texttt{admin} dispone de funciones con las que puede cambiar, para cualquier usuario, tanto el estado booleano de identidad verificada como el estado booleano de exclusión global.\par\vspace{0.45em}
...
\noindent\textbf{AC-RF-IAM-016 --- Facultad limitada del promotor sobre verificación y bloqueo local}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} El promotor puede marcar como verificada la identidad de un usuario vinculado a su evento; puede aplicar bloqueo local respecto de sus propios eventos cuando exista una protesta registrada por otro competidor o una morosidad local válida por incumplimiento de entrega o modificación indebida del vehículo antes de la subasta. No puede imponer exclusión global ni modificar la verificación reforzada.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Un usuario solo puede ejecutar funciones operativas generales cuando su estado de identidad verificada sea verdadero, su cuenta tenga correo confirmado y cuenta de pagos utilizable cuando esas condiciones apliquen a la implementación vigente, su estado de exclusión global sea falso y tenga aceptación vigente de términos y condiciones; si el estado de exclusión global es verdadero, no puede participar aunque la identidad esté verificada. En eventos de un promotor concreto, el sistema rechaza además las operaciones del usuario cuando exista bloqueo local vigente respecto de ese promotor.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Activar la exclusión global de un usuario autenticado y comprobar que la sesión deja de autorizar operaciones.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-021 --- Rechazo de inicio de sesión durante exclusión global activa}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Intentar iniciar sesión con un usuario con exclusión global activa y comprobar que el acceso se rechaza.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-022 --- Mensaje de exclusión al rechazar el inicio de sesión}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Intentar iniciar sesión con un usuario con exclusión global activa y comprobar la presencia del mensaje aplicable.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-023 --- Conservación de rastro verificable de cambios en verificación, exclusión global y bloqueos locales}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando \texttt{admin} o un promotor competente cambian alguno de esos estados de un usuario, el sistema conserva un registro consultable del actor, la marca temporal, el usuario afectado, el cambio efectuado y, cuando corresponda, el promotor al que se limita el bloqueo local, sin alterar por ello las reglas de reserva o visibilidad aplicables a esos estados.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-024 --- Exclusión global de nueva identidad detectada como correspondiente a un usuario con exclusión global}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando el sistema registra una detección válida de correspondencia entre una nueva identidad y un usuario con exclusión global activa, la nueva identidad queda marcada también con exclusión global activa.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-025 --- Consulta personal de los estados booleanos del usuario}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Un usuario puede consultar en el sistema si su identidad está marcada como verificada o no verificada, si su verificación reforzada está activa o inactiva, si su exclusión global está activa o no y qué bloqueos locales vigentes le corresponden.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} \texttt{admin} puede consultar para cualquier usuario si su identidad está verificada, si su verificación reforzada está activa, si su exclusión global está activa y qué bloqueos locales vigentes tiene registrados.\par\vspace{0.45em}
...
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} En la consulta pública del evento se muestran los datos públicos del evento y de sus procesos visibles, pero no se muestran los estados de identidad verificada, verificación reforzada, exclusión global o bloqueos locales de los usuarios vinculados a ese evento, ni el nivel derivado de ellos.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-033 --- Visibilidad general de usuarios no verificados y reserva de usuarios con exclusión global}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Un usuario no verificado puede seguir apareciendo en las consultas del sistema o del evento que le correspondan por las demás reglas del dominio; un usuario con exclusión global activa no aparece en consultas generales de usuarios para otros usuarios y sí aparece para \texttt{admin}, mientras el propio usuario puede seguir consultando sus estados, su nivel y sus bloqueos locales vigentes.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-034 --- Solicitud del promotor de exclusión global a admin}\par
\textbf{Método:} Prueba funcional con promotor, admin y usuario afectado.\par
\textbf{Oráculo:} Una solicitud razonada del promotor queda registrada para decisión de admin y no activa por sí sola la exclusión global.\par\vspace{0.45em}
\noindent\textbf{AC-RF-IAM-035 --- Privacidad de solicitudes globales rechazadas y publicación de exclusiones aceptadas}\par
\textbf{Método:} Prueba de publicación y permisos con una solicitud rechazada y otra aceptada.\par
\textbf{Oráculo:} La solicitud rechazada conserva rastro verificable y queda visible solo para admin, promotor solicitante y usuario afectado; la exclusión global aceptada publica decisión, alcance y razón suficiente. No existe operación de apelación dentro de TOP Racing.\par\vspace{0.45em}
\noindent\textbf{AC-RF-REP-001 --- Registro de calificación del promotor por participantes}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Después del evento, un participante vinculado puede registrar de una a cinco estrellas y un comentario opcional como opinión de competidor.\par\vspace{0.45em}
\noindent\textbf{AC-RF-REP-002 --- Registro de calificación del promotor por espectadores}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Después del evento, un espectador vinculado puede registrar de una a cinco estrellas y un comentario opcional como opinión de espectador.\par\vspace{0.45em}
\noindent\textbf{AC-RF-REP-003 --- Determinación de la reputación del promotor}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Cuando existan calificaciones anteriores, el sistema conserva dos reputaciones diferenciadas del promotor, una derivada de competidores y otra de espectadores, sin fusionarlas.\par\vspace{0.45em}
\noindent\textbf{AC-RF-REP-004 --- Aplicación de la reputación del promotor a eventos futuros}\par
\textbf{Método:} Prueba funcional de caja negra.\par
\textbf{Oráculo:} Para un promotor con eventos futuros, el sistema vincula a esos eventos las reputaciones vigentes separadas de competidores y espectadores y mantiene sus comentarios clasificados por origen.\par\vspace{0.45em}
...
\textbf{Método:} Prueba de interacción y autorización observable.\par
\textbf{Oráculo:} Activar la exclusión global de un usuario autenticado y comprobar que la sesión deja de autorizar operaciones.\par\vspace{0.45em}
\noindent\textbf{AC-UI-006 --- Bloqueo de inicio de sesión de usuario con exclusión global}\par
\textbf{Método:} Prueba de interacción y autorización observable.\par
\textbf{Oráculo:} Intentar iniciar sesión con un usuario con exclusión global activa; el acceso se rechaza y se muestra el mensaje definido.\par\vspace{0.45em}
...
\textbf{Método:} Prueba de interacción y autorización observable.\par
\textbf{Oráculo:} Registrar una objeción, una votación y una decisión; comprobar su asociación y secuencia con rastro verificable en el evento.\par\vspace{0.45em}
...
\textbf{Método:} Prueba de interacción y autorización observable.\par
\textbf{Oráculo:} Marcar el caso aplicable y comprobar que la inscripción queda sin velocidad válida capturada y conserva el rastro verificable de la decisión operativa correspondiente.\par\vspace{0.45em}
...
\noindent\textbf{AC-UI-066 --- Publicación de discriminadores y IPE por evento}\par
\textbf{Método:} Prueba de interacción y autorización observable.\par
...
\noindent\textbf{AC-UI-067 --- Ordenamiento consultable por IPE}\par
\textbf{Método:} Prueba de interacción y autorización observable.\par
\textbf{Oráculo:} Solicitar el orden por IPE y comprobar que la secuencia corresponde a los valores publicados.\par\vspace{0.45em}
...
\noindent\textbf{AC-UI-070 --- Declaración de categoría tecnológica abierta a soluciones diversas}\par
\textbf{Método:} Prueba de interfaz de publicación e inscripción.\par
\textbf{Oráculo:} Al publicar un evento se registran y muestran sus condiciones técnicas y de seguridad y se informa que cualquier tecnología compatible puede participar; al inscribir un vehículo el sistema no exige documentación técnica abierta ni revelación de secretos como condición general de TOP Racing.\par\vspace{0.45em}
...
\textbf{Método:} Prueba negativa/positiva de restricción externa.\par
\textbf{Oráculo:} Un usuario puede consultar la información pública disponible, pero no puede inscribirse, pujar, aportar, promover, presentar protestas ni ejecutar otras operaciones de participación dentro del sistema si su identidad no está verificada, si su exclusión global está activa o si existe bloqueo local vigente respecto del promotor aplicable.\par\vspace{0.45em}
\noindent\textbf{AC-RC-EXT-007 --- Verificación reforzada obligatoria para operaciones de mayor riesgo}\par
\textbf{Método:} Prueba negativa/positiva de restricción externa.\par
\textbf{Oráculo:} Un usuario que no tenga verificación reforzada activa no puede inscribir vehículos, pujar en subastas de vehículos ni promover eventos, aunque tenga identidad verificada, no tenga exclusión global activa y haya aceptado la versión vigente de términos y condiciones.\par\vspace{0.45em}
\noindent\textbf{AC-RC-EXT-008 --- Aceptación de la versión vigente de términos y condiciones antes de la participación}\par
\textbf{Método:} Prueba negativa/positiva de restricción externa.\par
\textbf{Oráculo:} Un usuario puede consultar la información pública disponible, pero no puede inscribirse, pujar, aportar, promover, presentar protestas ni ejecutar otras operaciones de participación dentro del sistema si no tiene aceptación registrada de la versión vigente de términos y condiciones. La versión vigente puede consultarse antes de aceptarse y desde el perfil del participante; muestra versión, fecha de vigencia y texto completo en lenguaje claro. Esa versión contiene las consecuencias económicas materiales de cada operación sensible, incluidas devoluciones, casos no reembolsables por descalificación o incumplimiento, bloqueos, morosidad y exclusión. Al aceptar, el sistema conserva participante, versión aceptada y fecha/hora; al cambiar la versión vigente, un usuario con aceptación anterior queda bloqueado para operaciones protegidas hasta aceptar la nueva versión.\par\vspace{0.45em}
...
\noindent\textbf{AC-QR-002 --- Auditabilidad y rastro verificable de operaciones críticas}\par
\textbf{Método:} Inspección, medición o prueba UX según el atributo.\par
...
\textbf{Método:} Inspección, medición o prueba UX según el atributo.\par
\textbf{Oráculo:} Ejecutar casos de invalidación y comparar todas las derivaciones afectadas antes y después; los registros invalidados dejan de computar sin perder su rastro histórico verificable.\par\vspace{0.45em}
...
\texttt{RF-AUC-036} & -- & \texttt{DEC-186}; revelación privada posterior del registro de pujas mediante tarifa a TOP Racing.\\
...
\texttt{RF-PUB-010} & \texttt{RF-070A} & RF-050G a RF-050J, RF-067D, RF-067E y fuentes prioritarias confirmadas por el usuario sobre historial y rastro temporal verificable de la disputa de entrega.\\
...
\texttt{RF-IAM-006} & \texttt{RF-072B} & RF-050B, RF-050J, DEC-189 y DEC-190; separación entre morosidad o bloqueo local del promotor y exclusión global decidida por \texttt{admin}.\\
...
\texttt{RF-SPN-009} & \texttt{RF-129B} & Secciones 2.6.4 y decisión confirmada por el usuario sobre devolución inmediata por cancelación reembolsable y ausencia de devolución automática por descalificación atribuible al participante.\\
...
\texttt{RF-IAM-020} & \texttt{RF-151B} & Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.\\
\texttt{RF-IAM-021} & \texttt{RF-151B} & Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.\\
\texttt{RF-IAM-022} & \texttt{RF-151B} & Secciones 2.5, RF-148, RF-151, 3.1.25, RIE-001 y decisión prioritaria del cliente confirmada sobre cancelación de sesión y rechazo de inicio de sesión por exclusión global activa.\\
...
\texttt{RF-IAM-033} & \texttt{RF-157} & Secciones 2.3, 2.5, RF-148, RF-154 y decisiones prioritarias del cliente sobre usuarios no verificados y usuarios con exclusión global.\\
\texttt{RF-IAM-034} & -- & \texttt{DEC-190}; solicitud del promotor de exclusión global para decisión exclusiva de admin.\\
\texttt{RF-IAM-035} & -- & \texttt{DEC-191}; privacidad de solicitudes rechazadas y publicación de exclusiones aceptadas.\\
...
\texttt{UI-070} & -- & \texttt{DEC-173}, \texttt{DEC-174}, \texttt{DEC-175}, \texttt{DEC-180}; categoría tecnológica admitida sin obligación general de documentación técnica abierta.\\
...
\noindent\textbf{RAT-BR-TEC-001.} Rationale confirmado: el objetivo institucional de TOP Racing es incentivar mérito tecnodeportivo, no gasto absoluto. El mecanismo premia a participantes que logran rendimiento observado alto con una valoración económica inferior a la tendencia del evento, y simultáneamente reconoce la destreza deportiva necesaria para extraer rendimiento del vehículo. La plataforma puede operar con categorías locales, caseras, artesanales, reutilizadas o de bajo costo sujetas a libertad tecnológica dentro de las reglas publicadas, porque su referencia de eficiencia es endógena al evento y no exige que la región compita contra una frontera tecnológica global. Este rationale no convierte por sí mismo una hipótesis de política pública en obligación de software ni afirma causalidad empírica sin validación posterior.\par
\noindent\textbf{RAT-BR-TEC-002.} Rationale confirmado: cuando el dueño puja $v$, toda puja externa superior puede adquirir el vehículo. Esa adquisición puede tener valor no solo de uso o reventa, sino también de aprendizaje, inspección e ingeniería inversa física permitida por las reglas aplicables. En consecuencia, la subasta puede funcionar como canal de comercio y difusión tecnológica regional sobre los vehículos físicos transferidos; TOP Racing no exige que su documentación técnica sea abierta. La SRS no presupone que la plataforma pueda sustituir límites legales de propiedad intelectual, seguridad, derechos de terceros, control físico del evento o restricciones externas de acceso.\par
...
2.6 normativa consolidada & 2026-07-21 & Introdujo una interpretación de ``tecnología abierta'' como obligación documental; esa interpretación queda expresamente superada por v2.7 al aclarar que Technology Open significa apertura a cualquier tecnología, no Open Technology.\\
2.7 normativa consolidada & 2026-08-12 & Corrige Technology Open, introduce IPE con factor $N_a-1$, pujas mínimas automáticas de una unidad, reputaciones separadas de competidores y espectadores, publicación de votación y resolución de protestas, y separación entre bloqueo local del promotor y exclusión global inapelable decidida por admin.\\
\bottomrule
\end{longtable}
...
\noindent\textbf{Estado booleano de exclusión global del usuario.} valor lógico que expresa si el usuario tiene exclusión global activa o no tiene exclusión global activa dentro del sistema.\par
\noindent\textbf{Morosidad local.} declaración válida de incumplimiento operativo asociada a un promotor concreto y a un usuario concreto; por sí sola no equivale a exclusión global.\par
\noindent\textbf{Bloqueo local por promotor.} restricción operativa derivada de una morosidad local o de una protesta válida, aplicable solo a eventos presentes o futuros del mismo promotor.\par
\noindent\textbf{Nivel de verificación del usuario.} nivel visible derivado de los estados booleanos de identidad verificada, verificación reforzada, exclusión global, bloqueos locales aplicables y aceptación legal, utilizado para informar qué operaciones puede realizar.\par
...
\noindent\textbf{Distribución económica posterior.} reparto posterior al resultado económico individual de un participante entre el propio participante y las personas asociadas a las contribuciones hechas a su favor, según las reglas publicadas.\par
\noindent\textbf{Dueño de vehículo.} papel funcional del usuario al que pertenece un vehículo registrado en el sistema y que administra su información dentro del contexto del sistema y del evento.\par
\noindent\textbf{Vehículo de competición.} artefacto físico admitido por una categoría de evento para producir rendimiento medible en pista; puede usar cualquier tecnología compatible con las reglas publicadas y las restricciones de seguridad del evento.\par
\noindent\textbf{Technology Open / apertura a la tecnología.} principio transversal de TOP Racing por el cual la competición está abierta al uso de cualquier tecnología compatible con las reglas publicadas del evento. No significa \emph{Open Technology}: TOP Racing no exige por este principio publicar, documentar, revelar, licenciar ni ceder secretos técnicos. La transferencia física obligatoria del vehículo adjudicado por subasta se rige por sus propias reglas y no convierte la solución técnica en información pública.\par
...
\noindent\textbf{Congestión competitiva de peso.} efecto por el cual la presencia o entrada de eventos comparables puede reducir el peso de otros eventos en ámbitos superiores compartidos al modificar su rango por IPE.\par
...
\noindent\textbf{Promotor.} usuario que convoca y administra un evento específico conforme a las reglas publicadas.\par
\noindent\textbf{Índice de Prioridad (IPE).} indicador publicado propio de un evento que interviene en la determinación de su matriz de pesos conforme a las reglas del dominio; en esta versión se deriva del pozo económico oficial, participantes activos y costo efectivo por participante.\par
...
\noindent\textbf{TOP.} sigla de \texttt{Technology Open Professional}: una competición abierta al uso de cualquier tecnología compatible con las reglas publicadas y operada con carácter profesional. ``Open'' modifica la apertura a la tecnología y no significa Open Technology ni apertura obligatoria del diseño.\par
...
\noindent\textbf{Rastro verificable de requisitos.} capacidad de relacionar cada requerimiento con su origen y con sus artefactos de validación.\par
\noindent\textbf{Rastro verificable histórico de resultados.} capacidad de consultar un resultado oficial junto con las reglas publicadas y los datos oficiales que lo sustentan, dentro del historial del evento.\par
...
\noindent\textbf{Consulta personal de estados del usuario.} consulta en la que el propio usuario puede ver sus estados booleanos de identidad verificada y exclusión global, así como los bloqueos locales vigentes que le correspondan.\par
\noindent\textbf{Consulta limitada del promotor sobre estados del usuario.} consulta restringida por la cual el promotor puede ver los estados booleanos de verificación, exclusión global y bloqueo local solo de usuarios vinculados operativamente a su evento y solo durante el ciclo de vida de ese evento.\par
...
Cuando dos eventos comparables tengan el mismo IPE en la determinación de la matriz de pesos, el desempate debe favorecer al evento registrado antes en el sistema.\par\vspace{0.45em}
...
\noindent\textbf{DEC-056 --- Falta de entrega o modificación previa a custodia [precisada por DEC-189 y DEC-190]}\par
Si, antes de iniciar la subasta, el dueño no entrega el vehículo al promotor o lo modifica o daña deliberadamente antes de entregarlo, el promotor puede descalificarlo, declararlo moroso y aplicar bloqueo local respecto de sus propios eventos. Cualquier exclusión global de TOP Racing requiere decisión exclusiva de admin conforme a DEC-190.\par\vspace{0.45em}
...
\noindent\textbf{DEC-077 --- La identidad verificada, la exclusión global y los bloqueos locales se representan como estados independientes}\par
El estado del usuario respecto de identidad y exclusión global debe representarse mediante valores booleanos independientes. Los bloqueos locales por promotor se representan como registros separados vinculados al promotor aplicable y no sustituyen al booleano de exclusión global.\par\vspace{0.45em}
\noindent\textbf{DEC-078 --- El promotor solo puede verificar identidad y aplicar bloqueo local a usuarios vinculados a su evento}\par
El promotor puede marcar como verificada la identidad de un usuario y puede aplicar bloqueo local únicamente si ese usuario está vinculado operativamente a un evento que él promueve, y solo con efectos sobre eventos presentes o futuros de ese mismo promotor.\par\vspace{0.45em}
\noindent\textbf{DEC-079 --- \texttt{admin} puede verificar, desverificar, imponer y levantar exclusión global a cualquier usuario}\par
\texttt{admin} puede modificar globalmente los estados de identidad y exclusión global del usuario, tanto para verificar o desverificar identidad como para imponer o levantar la exclusión global.\par\vspace{0.45em}
\noindent\textbf{DEC-080 --- El usuario con exclusión global no puede participar aunque tenga identidad verificada}\par
Si un usuario tiene exclusión global activa, no puede participar operativamente en TOP Racing aunque su identidad permanezca verificada.\par\vspace{0.45em}
\noindent\textbf{DEC-081 --- El propio usuario ve sus estados de verificación, exclusión global y bloqueos locales}\par
El propio usuario puede consultar en el sistema si su identidad está verificada o no, si su exclusión global está activa o no y qué bloqueos locales vigentes le correspondan.\par\vspace{0.45em}
\noindent\textbf{DEC-082 --- Otros usuarios no ven los estados de otros usuarios}\par
Ningún usuario distinto de \texttt{admin} o del propio usuario puede consultar públicamente o por simple navegación los booleanos de verificación, exclusión global o bloqueos locales de otro usuario.\par\vspace{0.45em}
\noindent\textbf{DEC-083 --- Los usuarios con exclusión global activa solo son visibles para \texttt{admin} en las consultas generales de usuarios}\par
En las consultas generales de usuarios del sistema, los usuarios con exclusión global activa solo deben ser visibles para \texttt{admin}, sin perjuicio de que el propio usuario pueda consultar sus propios estados y bloqueos locales vigentes.\par\vspace{0.45em}
...
El sistema debe obtener, conservar y versionar la aceptación explícita de términos y condiciones por parte de cada usuario antes de habilitarle cualquier participación operativa en el ecosistema, y debe exigir la aceptación de la versión vigente cuando esos términos cambien. Las reglas vigentes deben poder consultarse antes de la aceptación y en cualquier momento desde el perfil del participante, con versión, fecha de vigencia y texto completo. Las condiciones aceptadas deben informar en lenguaje claro las consecuencias económicas materiales, incluidas devoluciones, casos no reembolsables por descalificación o incumplimiento, bloqueos, morosidad y exclusión aplicables. La redacción legal final puede variar por país, pero TOP Racing debe conservar como base mínima el aviso visible, la consulta permanente, la aceptación explícita y el registro verificable de participante, versión y fecha/hora.\par\vspace{0.45em}
...
\noindent\textbf{DEC-095 --- Las devoluciones por cancelación reembolsable se ejecutan de inmediato}\par
Si un evento se cancela o si una inscripción se cancela antes de \texttt{carrera} por causa no atribuible al participante, el sistema debe devolver de inmediato los importes cobrados que correspondan. La descalificación por incumplimiento, fraude, conducta insegura, no entrega del vehículo, modificación indebida o violación de reglas no genera devolución automática a favor del participante descalificado; cualquier excepción requiere revisión documentada y decisión explícita conforme a las reglas aceptadas y a la ley aplicable.\par\vspace{0.45em}
...
\noindent\textbf{DEC-098 --- Si el promotor permanece moroso, queda con exclusión global pero sus eventos ya realizados siguen valiendo para campeonatos}\par
Cuando \texttt{admin} mantenga la morosidad del promotor por no entregar un vehículo adjudicado, el promotor queda con exclusión global activa, sin invalidar por ello los eventos ya realizados para efectos de campeonatos.\par\vspace{0.45em}
...
La naturaleza de TOP no descansa en la competencia física entre deportistas humanos, sino en la evaluación competitiva de soluciones de movilidad o desplazamiento, con control humano directo, control remoto o control autónomo, bajo reglas comunes y rastro verificable.\par\vspace{0.45em}
...
Cuando la inscripción corresponda a un sistema autónomo, el sistema debe registrar a la persona responsable de ese sistema para efectos de identificación, cumplimiento, seguridad y rastro verificable.\par\vspace{0.45em}
...
La sigla \texttt{TOP} dentro del nombre institucional \texttt{TOP Racing} significa literalmente \texttt{Technology Open Professional}: abierto a cualquier tecnología compatible con las reglas del evento y de carácter profesional; no significa Open Technology ni impone apertura del diseño.\par\vspace{0.45em}
\noindent\textbf{DEC-139 --- Interpretación histórica de Professional [superada por DEC-192]}\par
Esta decisión se conserva como antecedente histórico, pero queda superada en cuanto pretendía definir Professional por la posibilidad de profesionalización económica de los participantes.\par\vspace{0.45em}
\noindent\textbf{DEC-140 --- El público pagador del evento es la fuente principal esperada de recursos del ecosistema}\par
El modelo del ecosistema debe apoyarse principalmente en que el público pague por divertirse en los eventos. De esa base deben surgir los recursos del evento que sostienen a promotores, facilitan mejorar el IPE y hacen posible la profesionalización progresiva de los protagonistas.\par\vspace{0.45em}
...
\noindent\textbf{DEC-148 --- Mayores ingresos de promotores aumentan el interés de otros promotores y facilitan mejorar el IPE}\par
Cuando un evento produce mayores ingresos a promotores, ello debe aumentar el interés de otros promotores por participar en el ecosistema y facilitar nuevas mejoras del IPE.\par\vspace{0.45em}
...
\noindent\textbf{DEC-151 --- Definición operacional de costo efectivo y participantes activos para IPE}\par
El costo efectivo por participante es el costo mínimo obligatorio publicado de una inscripción ordinaria: inscripción, renta de pista imputable y pesaje obligatorio imputable cuando exista. Excluye aportaciones voluntarias, pujas, compras de vehículos, retenciones reembolsables y comisiones posteriores. El IPE de esta versión incorpora el número de participantes activos como factor de escala competitivo; cuando la renta solo se conoce como total del evento, la imputación por participante usa los participantes activos y aplica la convención de un participante si todavía no existe un número positivo.\par\vspace{0.45em}
...
\noindent\textbf{DEC-175 --- Interpretación histórica de apertura tecnológica [superada por DEC-181]}\par
Esta decisión se conserva únicamente como procedencia histórica. La interpretación que asociaba Technology Open con divulgación técnica queda superada por DEC-181 y no es normativa en v2.7.\par\vspace{0.45em}
...
La matriz de pesos debe interpretarse como una competencia por relevancia entre eventos que se solapan en los ámbitos comparativos definidos por las reglas territoriales y temporales del dominio. La entrada o mejora de IPE de un evento puede reducir el peso de otros eventos comparables en campeonatos superiores compartidos.\par\vspace{0.45em}
\noindent\textbf{DEC-178 --- La matriz de pesos genera una prima potencial de diferenciación territorial y temporal}\par
Un promotor situado en un rango inferior puede responder mejorando el IPE de su evento o eligiendo un territorio o periodo con menor solapamiento competitivo. La recuperación potencial hacia peso 100 constituye una prima de diferenciación antes de costos de entrada, demanda y economías de red. Esta decisión documenta el incentivo inducido; no obliga al promotor a trasladarse ni garantiza que la expansión sea rentable.\par\vspace{0.45em}
...
\noindent\textbf{DEC-180 --- Interpretación documental de Technology Open [superada por DEC-181]}\par
Esta decisión se conserva como antecedente histórico de v2.6, pero queda sustituida íntegramente por DEC-181. En v2.7 no existe obligación transversal de publicar o documentar la solución técnica por el solo hecho de participar en TOP Racing.\par\vspace{0.45em}
\noindent\textbf{DEC-181 --- Technology Open significa abierto a cualquier tecnología, no Open Technology}\par
TOP Racing permite competir con cualquier tecnología compatible con las reglas publicadas del evento. El nombre Technology Open describe apertura a la tecnología; no exige documentación abierta, publicación de planos, software, procesos, secretos técnicos ni licenciamiento de la solución. DEC-175 y DEC-180 quedan superadas en cualquier sentido contrario.\par\vspace{0.45em}
\noindent\textbf{DEC-182 --- La transferencia física del vehículo no obliga a revelar documentación técnica}\par
El ganador externo de la subasta recibe el vehículo físico en la condición exigida por las reglas de entrega. Desde la transferencia puede usarlo, estudiarlo, modificarlo, desmontarlo, revenderlo o volver a competir con él; el vendedor no adquiere por ello una obligación adicional de revelar documentación o secretos.\par\vspace{0.45em}
\noindent\textbf{DEC-183 --- El indicador de prioridad se denomina IPE y usa el número de rivales}\par
El antiguo nombre P/C queda reemplazado por Índice de Prioridad del Evento (IPE). El factor competitivo es $N_a-1$, truncado en cero cuando corresponda, de modo que un evento de un solo participante no obtenga escala competitiva por competir contra sí mismo.\par\vspace{0.45em}
\noindent\textbf{DEC-184 --- Cada competidor mantiene una puja mínima automática de una unidad sobre cada vehículo}\par
Al iniciar la subasta de vehículos, cada competidor del evento tiene una puja vigente por defecto de una unidad monetaria sobre cada vehículo, incluido el propio. La puja automática puede aumentarse mientras la subasta permanezca abierta y su precedencia para empates deriva de la inscripción válida del competidor.\par\vspace{0.45em}
\noindent\textbf{DEC-185 --- Empates de puja favorecen a quien alcanzó primero el importe y el precio mínimo oficial es una unidad}\par
Si varias pujas máximas tienen el mismo importe, gana la que alcanzó primero ese importe. Con una sola puja válida, el precio oficial es una unidad monetaria por convención; con dos o más, se aplica normalmente el segundo precio.\par\vspace{0.45em}
\noindent\textbf{DEC-186 --- Cualquier usuario puede auditar privadamente las pujas cerradas pagando una tarifa a TOP Racing}\par
Después del cierre, cualquier usuario puede pagar la tarifa vigente para consultar privadamente el registro íntegro de pujas de una subasta. La consulta es exclusiva de quien paga, el ingreso corresponde a TOP Racing y la revelación no modifica ni reabre el resultado oficial.\par\vspace{0.45em}
\noindent\textbf{DEC-187 --- Las reputaciones de promotor de competidores y espectadores son separadas}\par
Después del evento, competidores y espectadores pueden valorar al promotor de una a cinco estrellas y añadir comentarios. Las dos familias de reputación se calculan, muestran y conservan por separado.\par\vspace{0.45em}
\noindent\textbf{DEC-188 --- La votación de una protesta es informativa y la resolución final del promotor también es pública}\par
La protesta puede someterse a votación de participantes, pero el resultado no es vinculante. El promotor registra la resolución final y la consulta pública conserva tanto la votación como la resolución, aun cuando sean contrarias entre sí, manteniendo reservada la identidad del presentante original cuando así lo exige la regla de privacidad.\par\vspace{0.45em}
\noindent\textbf{DEC-189 --- El promotor solo puede aplicar bloqueo local por causa válida y no puede alterar una subasta ya iniciada}\par
El promotor puede aplicar bloqueo local a un usuario respecto de sus propios eventos únicamente cuando exista una protesta de otro competidor o una morosidad local válida por incumplimiento de entrega o modificación indebida del vehículo antes de la subasta. Una vez iniciada la subasta de vehículos no puede descalificar al competidor ni cambiar la elegibilidad del vehículo para alterar esa subasta.\par\vspace{0.45em}
\noindent\textbf{DEC-190 --- La exclusión global de TOP Racing corresponde exclusivamente a admin y es inapelable}\par
Un promotor puede solicitar a admin una exclusión global, pero no imponerla. Solo admin puede decidir una exclusión global temporal o permanente. La decisión de admin es final e inapelable dentro de TOP Racing.\par\vspace{0.45em}
\noindent\textbf{DEC-191 --- Las solicitudes globales rechazadas no se publican}\par
Una solicitud de exclusión global rechazada conserva rastro verificable y queda accesible para admin, el promotor solicitante y el usuario afectado, pero no se hace pública para evitar daño reputacional por una acusación no acogida. Una exclusión global aceptada sí publica la decisión final, su alcance temporal y una razón suficiente.\par\vspace{0.45em}
\noindent\textbf{DEC-192 --- Professional significa carácter profesional de TOP Racing}\par
El componente \texttt{Professional} de \texttt{Technology Open Professional} significa que TOP Racing es una competición y un ecosistema de carácter profesional. La posibilidad de que existan amateurs, semiprofesionales o profesionales y de que algunos participantes obtengan ingresos es compatible con el sistema, pero no define el significado del término \texttt{Professional}.\par\vspace{0.45em}
...
\toprule
\textbf{Elemento} & \textbf{Fuente heredada} & \textbf{Versión 2.7}\\
\midrule
Requisitos formales heredados & 295 IDs & Conservados mediante mapa de procedencia; los compuestos críticos se atomizan.\\
Requisitos canónicos v2 & No aplica & 387 obligaciones normalizadas con criterio de aceptación asociado.\\
Decisiones prioritarias & 150 entradas heredadas & DEC-001 a DEC-192; DEC-181 a DEC-192 consolidan las correcciones normativas de Technology Open, IPE, pujas mínimas automáticas, reputación, exclusiones y significado de Professional.\\
Glosario & 157 términos heredados & 170 términos controlados: 157 conceptos heredados normalizados y 13 conceptos añadidos o consolidados en v2.2--v2.7.\\
