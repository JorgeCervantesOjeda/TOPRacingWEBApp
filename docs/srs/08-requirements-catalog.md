...
| REG-003 | Una inscripción cancelada o descalificada debe conservarse como historial visible con nota escrita y excluirse de resultados, puntos y subastas. | Parcial |
